...
class FooterTrafficLightWidget(CarTrafficLightWidget):
    def init_colors(self):
        ...
        self.colors[Color.RED] = self.create_oval(5, 5, 45, 45, fill=Color.RED, tags="footerColorRed")
        self.colors[Color.GREEN] = self.create_oval(5, 45, 45, 85, fill=Color.GREEN, tags="footerColorGreen")
